...
import com.efuture.omdmain.model.out.BusinessCompanyOutModel;
import com.efuture.omdmain.service.out.BusinessCompanyDeamonOutService;
...
public class BusinessCompanyDeamonServiceImpl extends JDBCCompomentServiceImpl<BusinessCompanyOutModel> implements BusinessCompanyDeamonOutService{
	public BusinessCompanyDeamonServiceImpl(FMybatisTemplate mybatisTemplate,String collectionName, String keyfieldName) {
	...
	public ServiceResponse search(ServiceSession session, JSONObject paramsObject) throws Exception {
		...
		config.put("code", "erpCode");
		config.put("name", "erpName");
		config.put("corp", "businessCompany");
