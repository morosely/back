...
import com.efuture.omdmain.model.out.ChannelInfoOutModel;
import com.efuture.omdmain.service.out.ChannelInfoDeamonOutService;
...
public class ChannelInfoDeamonOutServiceImpl extends JDBCCompomentServiceImpl<ChannelInfoOutModel> implements ChannelInfoDeamonOutService{
	public ChannelInfoDeamonOutServiceImpl(FMybatisTemplate mybatisTemplate,String collectionName, String keyfieldName) {
	...
	public ServiceResponse search(ServiceSession session, JSONObject paramsObject) throws Exception {
		...
		config.put("code", "channelCode");
		config.put("name", "channelName");
		config.put("channel", "channelInfo");
		config.put("isMarketChannel", "isMarketChannel");
