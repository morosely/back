...
@Table(name = "goodsspecprice")
public class GoodsSpecPriceModel {
    /**
     * 条码
     */
     ...
     */
    @Transient
    @ReferQuery(table="saleGoods",query="{barNo:'$barNo', erpCode:'$erpCode', shopId:'$shopId'}",set="{ssgid:'ssgid'}",operationFlags={OperationFlag.afterQuery})
    private Long ssgid;
    /**
     * 状态
     */
