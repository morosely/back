...
public class VenderModel {
    ...
    /**
     * 供应商类型 0-普通/1-自采/2-自由品牌/4-农户/5-采购
     */
    private Short venderType;

    /**
     * 合同性质 1=购销、2=代销、3=联营、4=租赁
     */
    ...
    /**
     * 获取供应商类型 0-普通/1-自采/2-自由品牌/4-农户/5-采购
     *
     * @return venderType - 供应商类型 0-普通/1-自采/2-自由品牌/4-农户/5-采购
     */
    ...
    /**
     * 设置供应商类型 0-普通/1-自采/2-自由品牌/4-农户/5-采购
     *
     * @param venderType 供应商类型 0-普通/1-自采/2-自由品牌/4-农户/5-采购
     */
    ...
    /**
     * 获取合同性质 1=购销、2=代销、3=联营、4=租赁
     *
     * @return contractType - 合同性质 1=购销、2=代销、3=联营、4=租赁
     */
    ...
    /**
     * 设置合同性质 1=购销、2=代销、3=联营、4=租赁
     *
     * @param contractType 合同性质 1=购销、2=代销、3=联营、4=租赁
     */
    ...
    /**
     * 获取结算标识 0=总部 1=采配中心 2=中心店 3=门店
     *
     * @return localFlag - 结算标识 0=总部 1=采配中心 2=中心店 3=门店
     */
    ...
    /**
     * 设置结算标识 0=总部 1=采配中心 2=中心店 3=门店
     *
     * @param localFlag 结算标识 0=总部 1=采配中心 2=中心店 3=门店
     */
