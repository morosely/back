...
<body>
	...
	<div style="padding-top: 5px; padding-bottom: 5px;">
		<input type="button" value="Add" onclick="addRow()" /> <input
			type="button" value="Remove" onclick="removeRow()" /> <input
			type="button" value="Save" onclick="saveData()"
		...
		<div id="editForm1" style="padding: 5px;">
			...
			<table style="width: 100%;">
				<tr>
					...
					<td style="width: 150px;"><input id="loginname"
						name="loginname" class="mini-textbox" /></td>
				...
				<tr>
					<td>性别：</td>
					<td><input id="gender" name="gender" class="mini-combobox"
						data="Genders" /></td>
					<td>年龄：</td>
					<td><input id="age" name="age" class="mini-spinner"
...
<body>
	...
	<br> JSTL URL: ${url} <br> Message: ${message} 
</body>
