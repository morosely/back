...
public class GoodsShopRefModel extends CommonModel{
...
//		return "'"+this.goodsCode+"','"+this.shopCode+"','"+this.erpCode+"',"+this.entId;
    ...
    //档口
    public String getStallCodeKeyValue() {
    	return "'"+this.stallCode+"','"+this.erpCode+"',"+this.entId;
    }
    
    //柜组
    public String getOrgCodeKeyValue() {
    ...
    //供应商编码
    public String getVenderCodeKeyValue() {
