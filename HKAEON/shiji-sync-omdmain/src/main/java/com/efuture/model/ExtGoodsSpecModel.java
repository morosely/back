...
public class ExtGoodsSpecModel {
    private Long egsid;
    ...
    public void setSpurSpec(String spurSpec) {
        this.spurSpec = spurSpec == null ? null : spurSpec.trim();
    }
    ...
    public void setSpurUnit(String spurUnit) {
        this.spurUnit = spurUnit == null ? null : spurUnit.trim();
    }
    ...
    public void setMpurSpec(String mpurSpec) {
        this.mpurSpec = mpurSpec == null ? null : mpurSpec.trim();
    }
    ...
    public void setMpurUnit(String mpurUnit) {
        this.mpurUnit = mpurUnit == null ? null : mpurUnit.trim();
    }
    ...
    public void setLpurSpec(String lpurSpec) {
        this.lpurSpec = lpurSpec == null ? null : lpurSpec.trim();
    }
    ...
    public void setLpurUnit(String lpurUnit) {
        this.lpurUnit = lpurUnit == null ? null : lpurUnit.trim();
    }
    ...
    public void setMinPurUnit(String minPurUnit) {
        this.minPurUnit = minPurUnit == null ? null : minPurUnit.trim();
    }
    ...
    public void setsDeliverySpec(String sDeliverySpec) {
        this.sDeliverySpec = sDeliverySpec == null ? null : sDeliverySpec.trim();
    }
    ...
    public void setsDeliveryUnit(String sDeliveryUnit) {
        this.sDeliveryUnit = sDeliveryUnit == null ? null : sDeliveryUnit.trim();
    }
    ...
    public void setmDeliverySpec(String mDeliverySpec) {
        this.mDeliverySpec = mDeliverySpec == null ? null : mDeliverySpec.trim();
    }
    ...
    public void setmDeliveryUnit(String mDeliveryUnit) {
        this.mDeliveryUnit = mDeliveryUnit == null ? null : mDeliveryUnit.trim();
    }
    ...
    public void setlDeliverySpec(String lDeliverySpec) {
        this.lDeliverySpec = lDeliverySpec == null ? null : lDeliverySpec.trim();
    }
    ...
    public void setlDeliveryUnit(String lDeliveryUnit) {
        this.lDeliveryUnit = lDeliveryUnit == null ? null : lDeliveryUnit.trim();
    }
    ...
    public void setMinDeliveryUnit(String minDeliveryUnit) {
        this.minDeliveryUnit = minDeliveryUnit == null ? null : minDeliveryUnit.trim();
    }
